...
// Autore: Emanuele Tinari & ChatGPT
...
(async function () {
  ...
  // 5c. 🔍 Trova contenitore scrollabile (evita sidebar)
  function findScrollable() {
    const hostname = window.location.hostname;

    // ChatGPT (https://chatgpt.com) – trova il div scrollabile all'interno del main
